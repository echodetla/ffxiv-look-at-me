...
public class ChatWatcher : IDisposable
{
        ...
        XivChatType type, int timestamp, ref SeString sender, ref SeString message, ref bool isHandled)
    {
        ...
        if (lookAtMePlugin.CachedLocalPlayer?.StatusFlags.HasFlag(StatusFlags.InCombat) ?? false)
        {
            return;
        }
        ...
        {
            var senderObject = objectTable.PlayerObjects.FirstOrDefault(x => x.Name.TextValue == playerPayload.PlayerName);
